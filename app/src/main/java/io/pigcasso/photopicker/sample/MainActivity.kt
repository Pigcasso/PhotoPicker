...
class MainActivity : AppCompatActivity() {
    ...
    private inner class ResultsAdapter(activity: Activity) : CommonAdapter<String>(R.layout.grid_item_result, ArrayList()) {
        ...
        init {
            ...
            val numColumns = activity.resources.getInteger(io.pigcasso.photopicker.R.integer.grid_num_columns)
            val horizontalSpacing = activity.resources.getDimensionPixelSize(io.pigcasso.photopicker.R.dimen.grid_horizontal_spacing)
